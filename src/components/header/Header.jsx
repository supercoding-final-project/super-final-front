...
const menti_access_token = "Bearer eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjUyNTIsImF1dGhvcml0aWVzIjpbIk1FTlRFRSJdLCJpYXQiOjE2OTUwNTExMjQsImV4cCI6MTcyNjU4NzEyNH0.v0ly5U3mVe15JyctMOHxBT_YZUZev5szX623gy1ND8s"
const mento_access_token = "Bearer eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjEwMDQsImF1dGhvcml0aWVzIjpbIk1FTlRPUiJdLCJpYXQiOjE2OTUwNTExMjQsImV4cCI6MTcyNjU4NzEyNH0.sCThkhy4Xe8YGCa0jdho1TteZ-BtLMl_iQHQSAeLn_w"
const Header = () => {
  ...
  return (
    <S.HeaderWrap>
      <div className="nav-wrapper">
        <S.MentoMentoSwapBox>
          <S.MentiSwapButton $mento={mento} onClick={mentiMentoSwapButton}>멘티</S.MentiSwapButton>
          <Icon name="NavBar" size={20} style={{ padding: '0 10px' }} />
          <S.MentoSwapButton $mento={mento} onClick={() => { mentiMentoSwapButton(); mentiToMento(); }}>멘토</S.MentoSwapButton>
        </S.MentoMentoSwapBox>
      </div>

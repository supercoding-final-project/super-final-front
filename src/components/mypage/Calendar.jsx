      ...
      {isOpenModal && (
        <S.OutSideModal onClick={closeModalHandler}>
          <S.ModalContent>
            ...
            <S.InSideModalBody>
              <S.DivFlex>
                <S.ModalCellText>1*하진수 멘토님 예약</S.ModalCellText>
                <S.ModalCellText>2*하진수 멘토님 예약</S.ModalCellText>
                <S.ModalCellText>3*하진수 멘토님 신청</S.ModalCellText>
                        ...
                        return (
                          <>
                            {mentoReservation.length < 13 ? (
                              <S.CellText key={idx}>{mentoReservation}</S.CellText>
                            ) : (
                              <S.CellText key={idx}>{longname}</S.CellText>
                            )}
                          </>
                        );
                      } else {
